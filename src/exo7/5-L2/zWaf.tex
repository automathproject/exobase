...
%\hskip-8cm
\begin{tabular}{cc}
\includegraphics[height=8cm, keepaspectratio]{../images/zWaf-1}&
\includegraphics[height=8cm, keepaspectratio]{../images/zWaf-2}\\
A&B\\
\includegraphics[height=8cm, keepaspectratio]{../images/zWaf-3}&
\includegraphics[height=8cm, keepaspectratio]{../images/zWaf-4}\\
C&D\end{tabular}
}
}
}
