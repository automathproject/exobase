...
\begin{enumerate}
    ...
    \begin{figure}[!ht] 
        \begin{center}\includegraphics[scale=0.5]{images/0wvO-1}\end{center}
        \caption{}
    \end{figure}
    
    \begin{figure}[!ht] 
        \begin{center}\includegraphics[scale=0.5]{images/0wvO-2}
            \caption{le point $O$ est à l'infini}\end{center}
    \end{figure}
    
    \begin{figure}[!ht] 
        \begin{center}\includegraphics[scale=0.4]{images/0wvO-3}
...
\begin{figure}[!ht] 
        \begin{center}\includegraphics[scale=0.6]{images/0wvO-4}\end{center}
        \caption{}
    \end{figure}
