...
$$\includegraphics{../images/dVYA-3}$$


\textbf{Graphe}.

$$\includegraphics{../images/dVYA-4}$$
...
$$\includegraphics{../images/dVYA-5}$$

\textbf{Graphe.}

$$\includegraphics{../images/dVYA-6}$$
...
$$\includegraphics{../images/dVYA-8}$$



\textbf{Graphe.}

$$\includegraphics{../images/dVYA-9}$$



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%}
    \item \question{$f_7(x)=e^{/\ln x}$.}
\reponse{$$\includegraphics{../images/dVYA-10}$$
...
\reponse{$$\includegraphics{../images/dVYA-11}$$


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%}
    \item \question{$f_{11}(x)=\Arcsin\sqrt{\frac{1}{2}-x}+\Arcsin\sqrt{\frac{1}{2}+x}$.}
\reponse{$$\includegraphics{../images/dVYA-12}$$


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%}
    \item \question{$f_{12}(x)=\frac{\Arcsin x}{x}$.}
\reponse{$$\includegraphics{../images/dVYA-13}$$
...
\reponse{$$\includegraphics{../images/dVYA-14}$$}
\end{enumerate}
}
